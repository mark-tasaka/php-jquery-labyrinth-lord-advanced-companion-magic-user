...
<body>
    ...
    include 'php/magic_userSpells.php';
    ...
    $spellsLevel8 = level8Spells ($level);
	...
	*/
	function Character() {
		...
		let magic_userCharacter = {
            ...
            "magicUserMessage": mageAbilities (<?php echo $level ?>),
      ...
      $("#magicUserSpecial").html(data.magicUserMessage);
