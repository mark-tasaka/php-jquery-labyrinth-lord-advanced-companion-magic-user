			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#magic_userForm").attr('action', "character/ll_magic_user_"+ $("#abilityScores").val() +  ".php");
